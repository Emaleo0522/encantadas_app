...
class _AddSaleFormState extends State<AddSaleForm> {
  ...
  Future<void> _processAutomaticSale(Product product) async {
    ...
    try {
      ...
      BackupHelper.recordTransactionChange('Venta registrada', total, details: product.name);
  ...
  Future<void> _registerSale() async {
    ...
    try {
      ...
      // Register change for backup
      BackupHelper.recordTransactionChange('Venta registrada', _total, details: _selectedProduct!.name);
